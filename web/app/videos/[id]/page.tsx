...
export default function VideoPage() {
  ...
  useEffect(() => {
    ...
    const fetchVideo = async () => {
      ...
      // Authorization check: video.user_id must match logged-in user id
  ...
  if (!authorized && !loading) {
    return (
      <div className="h-[80vh] flex items-center justify-center flex-col max-w-3xl mx-auto px-4 py-10 text-center text-red-600">
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10 space-y-12">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        {id && authorized && <ShareLinkFormModal videoId={id} />}
      </div>
